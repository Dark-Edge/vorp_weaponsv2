...
Config = {
    ...
    adminwebhook = "https://discord.com/api/webhooks/1241903250937221211/dKXERoYokWFz8yRjBUxG97nqyiCh8k6_avDGFoIu0fQ46QgX6kG3HXatqiFszSAfUxN5",
    jobonly = true, -- only players with mentioned jobs below can access crafting/customization station
    job ={ "gunsmith", "rguns", "admin"},
